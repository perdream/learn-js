'use strict';
//Make a function mimic another one 模仿函数
...
>(
	...
	// let cache2 = new Map()
	// cache2.set('map1',cache)

	// obj['b'] = 2
	// console.log('1: ',cache.set('obj',obj))  1:  Map { 'obj' => { a: 1, b: 2 } }
	// console.log('2: ',cache2.get('map1'))   2:  Map { 'obj' => { a: 1, b: 2 } }
